// LICENSE_CODE ZON
'use strict'; 
define(['jquery', 'backbone', '/util/escape.js', '/util/url.js',
    'typeahead', '/util/user_agent.js', 'underscore', '/util/etask.js',
    '/util/array.js', '/util/string.js', window.is_popup ?
    '/bext/pub/locale.js' : null, window.is_popup ? null :
    '/www/hola/pub/be.js', window.is_popup ? null : '/www/hola/pub/ui.js'],
    function($, Backbone, zescape, zurl, typeahead, user_agent, _, etask,
    array, string, T, be, ui){
if (!window.is_popup)
...
function suggest_remote(country){
    return '/unblock/autocomplete?src_country='
...
function redir(s){ location.href = '/unblock/'+(s.value||s)+'?go=1'; }
