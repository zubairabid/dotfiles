...
define(['jquery', 'underscore', '/bext/pub/backbone.js', '/util/etask.js',
    ...
    '/bext/pub/version_util.js', 'be_ver', '/util/rate_limit.js',
    ...
    storage, zescape, ajax, be_version_util, be_ver, rate_limit, be_svc, hash,
...
E.init = function(plugin_ver){
    if (E.inited)
        return;
    E.dll_have_status = be_version_util.cmp(be_util.version(),
        '1.4.764')>=0;
...
E.main_uninit = function(){
    ...
    return etask([function(){
        ...
        if (be_version_util.cmp(be_util.version(), '1.2.439')>=0)
            return;
