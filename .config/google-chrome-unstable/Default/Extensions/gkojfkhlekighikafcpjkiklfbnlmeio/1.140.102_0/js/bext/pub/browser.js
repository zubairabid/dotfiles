...
define(['jquery', '/util/etask.js', '/util/zerr.js', '/bext/pub/msg.js',
    ...
    '/bext/pub/version_util.js', '/bext/pub/transport.js',
    '/util/user_agent.js', '/util/util.js'],
    function($, etask, zerr, be_msg, be_backbone, be_chrome, _,
    be_version_util, be_transport, user_agent, zutil){
var chrome = window.chrome;
var is_popup = window.is_popup, is_tpopup = window.is_tpopup;
var use_msg = is_tpopup;
var use_backbone_over_msg = use_msg;
var bg = is_tpopup ? null : chrome.extension.getBackgroundPage();
...
function vcmp(v){ return be_version_util.cmp(zconf.ZON_VERSION, v); }
function bvcmp(v){ return be_version_util.cmp(E.browser_version, v); }
...
E.tabs = {
    ...
    capture_visible_tab: function(opt, cb){
        E.rpc.call_api('tabs', '', 'captureVisibleTab', [null, opt], cb); },
    on_created: {
    ...
    get_tab_connections: function(tab_id){
        return bg.be_bg_main.be_browser.msg.tab_connections[tab_id]; },
};
E.windows = {
...
E.cookies = {
    ...
    set: function(details, cb){
        E.rpc.call_api('cookies', '', 'set', [details], cb); },
