...
define(['jquery', 'underscore', '/util/etask.js', '/bext/pub/backbone.js',
    ...
    '/bext/vpn/pub/ajax.js', '/bext/pub/lib.js', '/util/util.js'],
    function($, _, etask, be_backbone, B, zerr, vpn_util, date,
    storage, be_util, zurl, be_ext, zescape, ajax, be_lib, zutil){
B.assert_bg('be_tabs');
var be_rules;
...
E.set_last_rule = function(tab_id, rule){
    if (!rule || !rule.enabled)
        delete tabs_last_rule[tab_id];
    tabs_last_rule[tab_id] = rule;
};

E.get_last_rule = function(tab_id){
    return tabs_last_rule[tab_id];
};
