...
make_link(E.ccgi, 'twitter', is_torch ? {
    text: 'Check out Hola for @TorchBrowser, I can now unblock '
    +'sites from any country! %(site)s',
} : {
    text: 'Check out %(product)s, I can now unblock '
...
make_link(E.ccgi, 'email', {
    ...
    +'It lets me browse the Internet faster and unblock sites '
