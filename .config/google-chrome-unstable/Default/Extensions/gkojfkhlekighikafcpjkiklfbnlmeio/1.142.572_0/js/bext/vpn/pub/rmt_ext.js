...
define(['jquery', 'underscore', '/bext/pub/backbone.js', '/util/etask.js',
    ...
    '/bext/pub/lib.js', '/bext/vpn/pub/slave.js',
...
E.check_ver = function(){
    ...
    return etask('check_ver', [function(){
        return be_bg_ajax.ccgi_ajax({url: conf.url_ccgi+'/ver.json',
            qs: be_ext.auth()});
    }, function(info){
        ver = info.ver;
        if (ver==E.ver)
...
E.init = function(){
    ...
    E.be_bg_ajax.init(be_vpn.be_tab_unblocker);
    if (window.hola)
