...
function check_need_ext_settings(){
    return be_ext.get('bg_ajax.is_active') || E.rules &&
        _.keys(E.rules.unblocker_rules).length && be_ext.get('r.vpn.on');
}
...
E.load_pac_file = function(last, force){
    ...
    var et = E.set_pac(pac_engine.gen_pac(json, options));
    E.has_pac = true;
    return et;
};
