...
define(['/bext/pub/backbone.js', '/bext/pub/browser.js', '/util/etask.js',
    ...
    '/util/url.js', '/bext/vpn/pub/util.js', '/bext/vpn/pub/agent.js', 'conf'],
...
TrialRemote.prototype.get_trial_active = function(root_url, ignore_ts){
    if (is_user_updated && !be_ext.get('user_id') || be_ext.get('is_premium'))
        return;
...
TrialRemote.prototype.set_trial = function(root_url, cmd, opt){
    ...
    return etask('trial_start', [function(){
        ...
        if (be_bg_main)
            be_bg_main.gclid_ga_event('trial_start', root_url);
        ...
        handler.trials.forEach(function(t){
            ...
            if (!E.get_trial_active(root_url))
            {
                if (!ended[root_url])
                {
                    ...
                    var be_bg_main = window.be_bg_main;
                    if (be_bg_main)
                        be_bg_main.gclid_ga_event('trial_end', root_url);
                    ended[root_url] = true;
                }
...
E.get_trial_agent_port = function(rule, def_port, route_opt){
...
E.init = function(be_rule){
    ...
    be_premium.on('user_updated', function(){ is_user_updated = true; });
