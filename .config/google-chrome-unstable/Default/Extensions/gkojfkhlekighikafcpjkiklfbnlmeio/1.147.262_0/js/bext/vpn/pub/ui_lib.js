...
;(function () {
    'use strict'; define(['exports', 'react', 'react-dom', 'classnames', 'react-transition-group', '/util/url.js', '/util/util.js', '/util/zerr.js', '/util/escape.js', '/util/date.js', '/bext/pub/locale.js', '/util/etask.js', '/bext/pub/browser.js', '/bext/vpn/pub/util.js', '/bext/pub/util.js', '/util/country.js', '/svc/vpn/pub/common_ui.js', '/util/storage.js', '/protocol/pub/countries.js', 'jquery', 'regenerator-runtime'], function (exports, _react, _reactDom, _classnames2, _reactTransitionGroup, _url, _util, _zerr, _escape, _date, _locale, _etask2, _browser, _util3, _util5, _country, _common_ui, _storage, _countries, _jquery) {Object.defineProperty(exports, "__esModule", { value: true });var _react2 = _interopRequireDefault(_react);var _reactDom2 = _interopRequireDefault(_reactDom);var _classnames3 = _interopRequireDefault(_classnames2);var _url2 = _interopRequireDefault(_url);var _util2 = _interopRequireDefault(_util);var _zerr2 = _interopRequireDefault(_zerr);var _escape2 = _interopRequireDefault(_escape);var _date2 = _interopRequireDefault(_date);var _locale2 = _interopRequireDefault(_locale);var _etask3 = _interopRequireDefault(_etask2);var _browser2 = _interopRequireDefault(_browser);var _util4 = _interopRequireDefault(_util3);var _util6 = _interopRequireDefault(_util5);var _country2 = _interopRequireDefault(_country);var _common_ui2 = _interopRequireDefault(_common_ui);var _storage2 = _interopRequireDefault(_storage);var _countries2 = _interopRequireDefault(_countries);var _jquery2 = _interopRequireDefault(_jquery);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _slicedToArray = function () {function sliceIterator(arr, i) {var _arr = [];var _n = true;var _d = false;var _e = undefined;try {for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) {_arr.push(_s.value);if (i && _arr.length === i) break;}} catch (err) {_d = true;_e = err;} finally {try {if (!_n && _i["return"]) _i["return"]();} finally {if (_d) throw _e;}}return _arr;}return function (arr, i) {if (Array.isArray(arr)) {return arr;} else if (Symbol.iterator in Object(arr)) {return sliceIterator(arr, i);} else {throw new TypeError("Invalid attempt to destructure non-iterable instance");}};}();function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var _extends = Object.assign || function (target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i];for (var key in source) {if (Object.prototype.hasOwnProperty.call(source, key)) {target[key] = source[key];}}}return target;};function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}var _createClass = function () {function defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}return function (Constructor, protoProps, staticProps) {if (protoProps) defineProperties(Constructor.prototype, protoProps);if (staticProps) defineProperties(Constructor, staticProps);return Constructor;};}();function _possibleConstructorReturn(self, call) {if (!self) {throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call && (typeof call === "object" || typeof call === "function") ? call : self;}function _inherits(subClass, superClass) {if (typeof superClass !== "function" && superClass !== null) {throw new TypeError("Super expression must either be null or a function, not " + typeof superClass);}subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } });if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass;}
        ...
        function perr(opt) {
            var be_popup_lib = window.popup_main.be_popup_lib;
            return be_popup_lib.perr_ok(opt);
        }

        E.open_report_problem = function () {
            perr({ id: 'be_report_problem', rate_limit: { count: 1 } });
            var url = 'about.html?' + _escape2.default.qs({ url: api.get_url() });
        ...
        Upgrade_link = function (_PureComponent) {_inherits(Upgrade_link, _PureComponent);function Upgrade_link() {var _ref2;var _temp2, _this6, _ret2;_classCallCheck(this, Upgrade_link);for (var _len2 = arguments.length, args = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {args[_key2] = arguments[_key2];}return _ret2 = (_temp2 = (_this6 = _possibleConstructorReturn(this, (_ref2 = Upgrade_link.__proto__ || Object.getPrototypeOf(Upgrade_link)).call.apply(_ref2, [this].concat(args))), _this6), _this6.
                ...
                onClick = function () {
                    ...
                    if (be_bg_main)
                    be_bg_main.gclid_ga_event('go_plus', 'upgrade_link');
                    api.ui_popup.open_page(plus_ref('ext_upgrade2', { root_url:
                        _this6.props.root_url }));
                }, _temp2), _possibleConstructorReturn(_this6, _ret2);}_createClass(Upgrade_link, [{ key: 'componentDidMount', value: function componentDidMount() {
        ...
        Trial_timer = function (_PureComponent5) {_inherits(Trial_timer, _PureComponent5);
            function Trial_timer(props) {_classCallCheck(this, Trial_timer);var _this10 = _possibleConstructorReturn(this, (Trial_timer.__proto__ || Object.getPrototypeOf(Trial_timer)).call(this,
                ...
                onClick = function () {
                    var be_bg_main = window.popup_main && window.popup_main.be_bg_main;
                    if (be_bg_main)
                    be_bg_main.gclid_ga_event('go_plus', 'timer');
        ...
        Popular_view_item = function (_React$PureComponent2) {_inherits(Popular_view_item, _React$PureComponent2);function Popular_view_item() {var _ref7;var _temp6, _this11, _ret6;_classCallCheck(this, Popular_view_item);for (var _len6 = arguments.length, args = Array(_len6), _key6 = 0; _key6 < _len6; _key6++) {args[_key6] = arguments[_key6];}return _ret6 = (_temp6 = (_this11 = _possibleConstructorReturn(this, (_ref7 = Popular_view_item.__proto__ || Object.getPrototypeOf(Popular_view_item)).call.apply(_ref7, [this].concat(args))), _this11), _this11.
                ...
                on_click = function () {return api.set_active_url(_this11.props.root_url);}, _temp6), _possibleConstructorReturn(_this11, _ret6);}_createClass(Popular_view_item, [{ key: 'render', value: function render()
                {
                    var p = this.props;var
                    state = this.state;
                    var cls = (0, _classnames3.default)('popup-popular-item',
                    p.is_ps ? 'premium-site' : 'free-site');
                    var cls_i = (0, _classnames3.default)('site-icon',
        ...
        var rate_us_urls = {
            ...
            firefox: 'https://addons.mozilla.org/ru/firefox/addon/hola-unblocker/' };var
        ...
        Enable_view = function (_PureComponent8) {_inherits(Enable_view, _PureComponent8);function Enable_view() {var _ref9;var _temp8, _this14, _ret8;_classCallCheck(this, Enable_view);for (var _len8 = arguments.length, args = Array(_len8), _key8 = 0; _key8 < _len8; _key8++) {args[_key8] = arguments[_key8];}return _ret8 = (_temp8 = (_this14 = _possibleConstructorReturn(this, (_ref9 = Enable_view.__proto__ || Object.getPrototypeOf(Enable_view)).call.apply(_ref9, [this].concat(args))), _this14), _this14.
                ...
                on_stars_click = function (num) {
                    perr({ id: 'be_vpn_rating_rate', info: { rate: num } });
                ...
                render_rated = function () {
                    ...
                    if (rating == 5 && !get_info('rate_on_store'))
                    {
                        ...
                        api.be_util.open_new_tab({ url: rate_us_urls[browser],
                            force_active: true });
                        return null;
                    }
                    return _react2.default.createElement(E.Vpn_rated, { show_link: rating == 5 && browser == 'chrome',
                ...
                render_bottom = function () {var _this15 = _this14,
                    ...
                    switch (_this14.state.bottom_component) {
                        ...
                        case 'rating':return _react2.default.createElement(E.Vpn_rating, { on_rate: _this14.on_stars_click });
                ...
                } }]);return Enable_view;}(PureComponent);


        E.Vpn_rating = function (_React$PureComponent3) {_inherits(Vpn_rating, _React$PureComponent3);function Vpn_rating() {_classCallCheck(this, Vpn_rating);return _possibleConstructorReturn(this, (Vpn_rating.__proto__ || Object.getPrototypeOf(Vpn_rating)).apply(this, arguments));}_createClass(Vpn_rating, [{ key: 'render', value: function render()
                {var
                    props = this.props;
        ...
        E.Vpn_rated = function (_React$PureComponent5) {_inherits(Vpn_rated, _React$PureComponent5);function Vpn_rated() {var _ref11;var _temp10, _this18, _ret10;_classCallCheck(this, Vpn_rated);for (var _len10 = arguments.length, args = Array(_len10), _key10 = 0; _key10 < _len10; _key10++) {args[_key10] = arguments[_key10];}return _ret10 = (_temp10 = (_this18 = _possibleConstructorReturn(this, (_ref11 = Vpn_rated.__proto__ || Object.getPrototypeOf(Vpn_rated)).call.apply(_ref11, [this].concat(args))), _this18), _this18.
                ...
                on_rate_us = function () {var
                    on_rate_us = _this18.props.on_rate_us;
                    (0, _etask3.default)(regeneratorRuntime.mark(function _callee3() {return regeneratorRuntime.wrap(function _callee3$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:_context4.next = 2;return (
                                            api.be_info.ecall('set_rate_on_store', [Date.now()]));case 2:
                                        perr({ id: 'be_rate_webstore_click' });
                                        on_rate_us && on_rate_us();case 4:case 'end':return _context4.stop();}}}, _callee3, this);}));

                }, _temp10), _possibleConstructorReturn(_this18, _ret10);}_createClass(Vpn_rated, [{ key: 'render', value: function render()
                {var
                    props = this.props;
                    return _react2.default.createElement('div', { className: 'popup-rated-view' },
                    !!props.show_link && _react2.default.createElement('a', { target: '_blank', rel: 'noopener noreferrer',
                        href: rate_us_urls[browser], onClick: this.on_rate_us,
                        className: 'rate-us' },
                    ...
                    !!props.show_thanks && _react2.default.createElement('span', null, 'Thanks for your feedback'));
        ...
        Vpn_work_buttons = function (_React$PureComponent6) {_inherits(Vpn_work_buttons, _React$PureComponent6);function Vpn_work_buttons() {var _ref12;var _temp11, _this19, _ret11;_classCallCheck(this, Vpn_work_buttons);for (var _len11 = arguments.length, args = Array(_len11), _key11 = 0; _key11 < _len11; _key11++) {args[_key11] = arguments[_key11];}return _ret11 = (_temp11 = (_this19 = _possibleConstructorReturn(this, (_ref12 = Vpn_work_buttons.__proto__ || Object.getPrototypeOf(Vpn_work_buttons)).call.apply(_ref12, [this].concat(args))), _this19), _this19.
                ...
                {
                    return this.state.click_no_count[api.get_tab_id()] >= 1;
        ...
        Modal_view = function (_React$PureComponent12) {_inherits(Modal_view, _React$PureComponent12);
            function Modal_view(props) {_classCallCheck(this, Modal_view);var _this30 = _possibleConstructorReturn(this, (Modal_view.__proto__ || Object.getPrototypeOf(Modal_view)).call(this,
                props));
                _this30.el = document.createElement('div');return _this30;
            }_createClass(Modal_view, [{ key: 'componentDidMount', value: function componentDidMount()
                {
                ...
                {var _props6 =
                    this.props,on_no = _props6.on_no,on_yes = _props6.on_yes;
                    return _reactDom2.default.createPortal(_react2.default.createElement('div', {
                        className: (0, _classnames3.default)('modal-view react-ui', this.props.cls) },
                    ...
                    this.el);
                } }]);return Modal_view;}(_react2.default.PureComponent);var



        Vpn_modal_view = function (_React$PureComponent13) {_inherits(Vpn_modal_view, _React$PureComponent13);_createClass(Vpn_modal_view, [{ key: 'componentDidMount', value: function componentDidMount()
                {var _this32 = this;
                    (0, _jquery2.default)('body').on('click.vpn_modal_view', function (e) {
                        if (_this32.state.show && !(0, _jquery2.default)(e.target).parents('.modal-view').length)
                        _this32.hide();
                    });
                } }, { key: 'componentWillUnmount', value: function componentWillUnmount()
                {
            ...
            function Vpn_modal_view(props) {_classCallCheck(this, Vpn_modal_view);var _this31 = _possibleConstructorReturn(this, (Vpn_modal_view.__proto__ || Object.getPrototypeOf(Vpn_modal_view)).call(this,
                props));_this31.toggle = function (isShow, yesClicked) {_this31.setState({ show: isShow });_this31.props.on_toggle(isShow, yesClicked);};_this31.show = function () {return _this31.toggle(true);};_this31.hide = function () {return _this31.toggle(false);};
                _this31.state = { show: props.show };return _this31;
            }_createClass(Vpn_modal_view, [{ key: 'componentWillReceiveProps', value: function componentWillReceiveProps(
                nextProps) {
                    this.setState({ show: nextProps.show });
                } }, { key: 'render', value: function render()
                {var _this33 = this;var
                    props = this.props;
                    ...
                    _react2.default.createElement('div', { className: 'btn_yes', onClick: function onClick() {return _this33.toggle(false, true);} },
        ...
        E.Link_mailto = function Link_mailto(props) {var _props$to =
            props.to,to = _props$to === undefined ? 'help_be@hola.org' : _props$to,on_click = props.on_click;
            var mailto_val = props.mailto_val || _util6.default.problem_mailto_url({ to: to });
        ...
        var is_offline = function is_offline() {return window.navigator.onLine === false;};var

        Alert_error = function (_React$PureComponent14) {_inherits(Alert_error, _React$PureComponent14);function Alert_error() {var _ref16;var _temp15, _this34, _ret15;_classCallCheck(this, Alert_error);for (var _len15 = arguments.length, args = Array(_len15), _key15 = 0; _key15 < _len15; _key15++) {args[_key15] = arguments[_key15];}return _ret15 = (_temp15 = (_this34 = _possibleConstructorReturn(this, (_ref16 = Alert_error.__proto__ || Object.getPrototypeOf(Alert_error)).call.apply(_ref16, [this].concat(args))), _this34), _this34.
                state = {}, _this34.
                update_status = function () {return (
                        _this34.setState({ offline: is_offline() }));}, _temp15), _possibleConstructorReturn(_this34, _ret15);}_createClass(Alert_error, [{ key: 'componentDidMount', value: function componentDidMount()
                {
                    this.update_status();
                ...
                {var
                    props = this.props;var
                    offline = this.state.offline;
                    var on_yes = function on_yes() {
                        var be_popup_lib = window.popup_main.be_popup_lib;
                ...
                } }]);return Alert_error;}(_react2.default.PureComponent);
        ...
        E.is_mouse_over = function (el, event) {
            if (!el)
            return false;
        ...
        E.Close_hint = function (_PureComponent10) {_inherits(Close_hint, _PureComponent10);function Close_hint() {var _ref17;var _temp16, _this36, _ret16;_classCallCheck(this, Close_hint);for (var _len16 = arguments.length, args = Array(_len16), _key16 = 0; _key16 < _len16; _key16++) {args[_key16] = arguments[_key16];}return _ret16 = (_temp16 = (_this36 = _possibleConstructorReturn(this, (_ref17 = Close_hint.__proto__ || Object.getPrototypeOf(Close_hint)).call.apply(_ref17, [this].concat(args))), _this36), _this36.
                state = { show: false, hover: false }, _this36.
                ...
                on_body_mouse_move = function (e) {
                    var over_close_btn = E.is_mouse_over(_this36.props.close_btn, e);
                    _this36.setState({ hover: E.is_mouse_over(_this36.el, e) ||
                        E.is_mouse_over(_this36.arrow_el, e) || over_close_btn });
                    if (!_this36.state.show && over_close_btn)
                    _this36.setState({ show: true });
                }, _this36.
                on_mouse_leave = function (e) {return _this36.setState({ hover: false });}, _this36.
                on_click_site = function () {return _this36.props.on_click(_this36.props.root_url);}, _this36.
                on_click_all = function () {return _this36.props.on_click('all');}, _this36.
                on_exited = function () {
                    if (_this36.props.on_hide)
                    _this36.props.on_hide();
                }, _temp16), _possibleConstructorReturn(_this36, _ret16);}_createClass(Close_hint, [{ key: 'componentDidMount', value: function componentDidMount() {(0, _jquery2.default)('body').on('mousemove', this.on_body_mouse_move);this.props.be_tpopup.on('mouseleave', this.on_mouse_leave);if (this.props.show_on_init) this.setState({ show: true });} }, { key: 'componentWillUnmount', value: function componentWillUnmount() {(0, _jquery2.default)('body').off('mousemove', this.on_body_mouse_move);this.props.be_tpopup.off('mouseleave', this.on_mouse_leave);clearTimeout(this.timer);} }, { key: 'componentDidUpdate', value: function componentDidUpdate(prev_props, prev_state) {var _this37 = this;if (prev_state.hover && !this.state.hover) this.timer = setTimeout(function () {return _this37.setState({ show: false });}, 300);if (!prev_state.hover && this.state.hover) this.timer = clearTimeout(this.timer);} }, { key: 'render', value: function render()
                {var _this38 = this;var
                    ...
                    var style = { display: 'block' },arrow_style = {};
                    if (props.offset)
                    {
                    ...
                    _react2.default.createElement('div', { className: 'popup-hint popup-header-close-hint',
                        style: style, ref: function ref(el) {return _this38.el = el;} },
                    _react2.default.createElement('div', { className: 'hint_close_arrow', style: arrow_style,
                        ref: function ref(el) {return _this38.arrow_el = el;} }),
                ...
                } }]);return Close_hint;}(PureComponent);
        ...
        var close_hint_el = void 0;
        E.render_close_hint = function () {var opt = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
            var parent = (0, _jquery2.default)('#tpopup_close').parent();
            close_hint_el = close_hint_el ||
            (0, _jquery2.default)('<div class=hint-root/>').appendTo(parent);
            _reactDom2.default.render(_reactDom2.default.createPortal(_react2.default.createElement(E.Close_hint, opt), parent[0]),
            close_hint_el[0]);
        };

        E.remove_close_hint = function () {
            if (!close_hint_el)
            return;
            _reactDom2.default.unmountComponentAtNode(close_hint_el[0]);
            close_hint_el.remove();
            close_hint_el = null;
        };

        E.alert_error = function () {return (0, _etask3.default)(regeneratorRuntime.mark(function _callee4() {var _this39 = this;var div;return regeneratorRuntime.wrap(function _callee4$(_context5) {while (1) {switch (_context5.prev = _context5.next) {case 0:
                                ...
                                _reactDom2.default.render(_react2.default.createElement(Alert_error, { on_close: function on_close() {return _this39.return();} }), div);_context5.next = 6;return (
                                    this.wait());case 6:case 'end':return _context5.stop();}}}, _callee4, this);}));};exports.default =
